<template>
	<section>
		...
		<!--列表-->
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" element-loading-text="列表数据加载中" @cell-click="openCellDetails" style="width: 100%;">
		...
		                <el-option v-for="option2 in selectionArr" :value="option2.menuCode" :key="option2.menuCode" :label="option2.menuName"></el-option>
		            </el-select>
				</el-form-item>
		...
		<!--选择角色用户弹框-->
		<el-dialog title="选择角色用户" :visible.sync="selectRoleDialogVisible" width="40%">
		  <template>
		  	<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
				<el-form :inline="true" :model="filtersRole">
					...
					<el-form-item>
						<el-button type="primary" v-on:click="searchFiltersRole">查询</el-button>
					</el-form-item>
				</el-form>
			</el-col>
		...
		<el-dialog title="已授权角色用户列表" :visible.sync="hasSelectedRoleDialogVisible" width="40%">
		  <template>
		  	<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
				<el-form :inline="true" :model="selectedRole">
					<el-form-item>
						<el-input v-model="selectedRole.name" placeholder="姓名"></el-input>
					</el-form-item>
					<el-form-item>
						<el-button type="primary" v-on:click="searchSelectedRole">查询</el-button>
					</el-form-item>
				</el-form>
			</el-col>
			...
			<!--工具条-->
			<el-col :span="24" class="toolbar">
				<el-pagination layout="total, sizes, prev, pager, next, jumper" @current-change="handleRoleUsersChange" :page-sizes="[20]" :total="total" style="float:right;">
				</el-pagination>
			</el-col>
		  </template>
		  <span slot="footer" class="dialog-footer">
